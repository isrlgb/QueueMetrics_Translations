...
td_cko_exit_with_key_press=Ende durch Funktionstaste
td_cko_incomp_channel=Unkomp. Kanal
td_cko_key_press=Funktiontaste
...
aout_call_res_by_tag=Anrufergebnisse, nach Markierung
aout_calltag=Anruf-Markierung
...
clage_calltag=Anruf-Markierung
clage_chart=Grafik
clage_cont=Cont.
clage_contph=CPH
...
cld_pop_calltag=Anruf-Markierung:
...
custrep_calltags=Anruf-Markierung aufrufen
...
clko_key=Key
clko_keypress=Unbeantwortete Anrufe durch Druck der Funktionstaste
...
clhdr_calltag=Gefiltert nach Anruf-Markierung:
...
evt_exit_with_key=Beenden mit Funktionstaste
...
hdr_tags=Markierungen
hdr_tags_title=Marierungen aufrufen
hdr_tasks=Aufgaben
...
edit_ct_tag=Markierung
edit_ct_title=Anruf-Markierung
...
edit_record_tags_code=Aufruf des Markierungs-Codes:
edit_record_tags_title=Anruf-Markierung bearbeiten
...
filter_calltags=Anruf-Markierung
...
Wallboardrt3_enter_title=Titel eingeben
...
rt3_error_saving_wb_missing_key=Der Benutzer kann kein Wallboard speichern, da die Benutzerschlüssel WALLBOARD_ADD fehlt
...
rt3_table_aggrbytag=Aggregiert nach Markierung
# 🔴 rt3_table_lastattempts -> Last attempts
➡️ rt3_table_lastattempts=letzter Versuch
...
rt3_wallboard_saved=Wallboardgespeichert
rt3_widget=Widget
...
fp_calltag_edit=Markierung aufrufen
fp_cbts_edit=CBTs
...
fp_qa_grader_page=Grader's Seite
...
propedit_key_blindxfer=Funktionscode für die Weiterleitung ohne Rückfrage
...
propedit_key_realtime_agent_web1_url=URL 1 (kann dynamische Markierungen haben, siehe Benutzerhandbuch)
...
keydesc_wallboard_add=Nutzer kann Wallboards erstellen und editieren
keydesc_wallboard_forall=Nutzer kann öffentliche Wallboardsspeichern
...
phone_blind_transfer=Weiterleitung ohne Rücfrage
# 🔴 phone_call -> Call
...
qap_control_addall= Queue auswählen
...
qap_control_removeall= Queue verlassen 
qap_control_selectall= alle auswählen
